...
screen_work.fill(colorWHITE)
instruments = pygame.Surface((295, 50))
instruments.fill(colorGRAY)
pygame.draw.rect(instruments, (colorBLACK), (5, 5, 40, 40), width=3)
pygame.draw.circle(instruments, (colorBLACK), (75, 25), radius=20, width=3)
pygame.draw.rect(instruments, (colorBLUE), (105, 5, 30, 40), width=0)
